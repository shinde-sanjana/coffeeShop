...
class _CoffeeDetailsState extends State<CoffeeDetails> {
  ...
  SmoothStarRating({required double rating, required bool isReadOnly, required int size, required IconData filledIconData, required IconData halfFilledIconData, required IconData defaultIconData, required int starCount, required bool allowHalfRating, required double spacing, required Null Function(dynamic value) onRated}) {}
}
